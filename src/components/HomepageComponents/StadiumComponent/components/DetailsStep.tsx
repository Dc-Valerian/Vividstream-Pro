    ...
    <div className="flex flex-col gap-5">
      <div className="space-y-4">
        <p className="text-[10px] text-gray-500 uppercase tracking-widest">
          {t("stadium.checkout.details.personalInfo")}
        </p>
        <div className="grid grid-cols-2 gap-3">
          <InputField
            label={t("visa.form.firstName")}
            value={details.firstName}
            onChange={(v) => onChange({ ...details, firstName: v })}
            placeholder={t("stadium.checkout.details.firstNamePlaceholder")}
          />
          <InputField
            label={t("visa.form.lastName")}
            value={details.lastName}
            onChange={(v) => onChange({ ...details, lastName: v })}
            placeholder={t("stadium.checkout.details.lastNamePlaceholder")}
          />
        </div>
        <InputField
          ...
          placeholder={t("stadium.checkout.details.emailPlaceholder")}
        />
        <InputField
          ...
          placeholder={t("stadium.checkout.details.phonePlaceholder")}
        />
        <div className="bg-yellow-400/5 border border-yellow-400/20 rounded-xl p-3.5">
          <p className="text-xs text-yellow-400/80">
            {t("stadium.checkout.details.ticketInfo")}
          </p>
        </div>
      </div>
